...
# All tested plot calls are wrapped in anonymus functions to avoid printing of
# the result of their calls (`NULL`). This seems to be a result of {vdiffr}
# approach: it `print()`s its input (resulting here with `NULL`), unless wrapped
# in function.

# plot.p_fun --------------------------------------------------------------
test_that("plot.p_fun works", {
  vdiffr::expect_doppelganger("plot-p-fun-1", function() {plot(p_raw_withx)})
  vdiffr::expect_doppelganger(
    "plot-p-fun-2", function() {plot(p_raw_withx, y = NA)}
  )
  vdiffr::expect_doppelganger(
    "plot-p-fun-3", function() {
      plot(p_raw_withx, xlab = "a", ylab = "b", main = "c", type = "p")
    }
  )
  vdiffr::expect_doppelganger(
    "plot-p-fun-4", function() {
  ...
  vdiffr::expect_doppelganger(
    "plot-lines-p-fun-1", function() {
      plot(p_smooth_withx)
      lines(p_custom)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-p-fun-2", function() {
      plot(p_smooth_withx, y = NA)
      lines(p_custom, y = NA)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-p-fun-3", function() {
      plot(p_smooth_withx, xlab = "a", ylab = "b", main = "c", type = "p")
      lines(p_custom, lwd = 2)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-p-fun-4", function() {
...
test_that("plot.p_fun and lines.p_fun respect `n_grid` argument", {
  vdiffr::expect_doppelganger(
    "plot-lines-p-fun-n-grid", function() {
...
test_that("plot.d_fun works", {
  ...
  vdiffr::expect_doppelganger(
    "plot-lines-d-fun-1", function() {
      plot(d_smooth_withx)
      lines(d_custom)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-d-fun-2", function() {
      plot(d_smooth_withx, y = NA)
      lines(d_custom, y = NA)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-d-fun-3", function() {
      plot(d_smooth_withx, xlab = "a", ylab = "b", main = "c", type = "p")
      lines(d_custom, lwd = 2)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-d-fun-4", function() {
...
test_that("plot.d_fun and lines.d_fun respect `n_grid` argument", {
  vdiffr::expect_doppelganger(
    "plot-lines-d-fun-n-grid", function() {
...
test_that("plot.q_fun works", {
  vdiffr::expect_doppelganger("plot-q-fun-1", function() {plot(q_raw_withx)})
  vdiffr::expect_doppelganger(
    "plot-q-fun-2", function() {plot(q_raw_withx, y = NA)}
  )
  vdiffr::expect_doppelganger(
    "plot-q-fun-3", function() {
      plot(q_raw_withx, xlab = "a", ylab = "b", main = "c", type = "p")
    }
  )
  vdiffr::expect_doppelganger(
    "plot-q-fun-4", function() {
  ...
  vdiffr::expect_doppelganger(
    "plot-lines-q-fun-1", function() {
      plot(q_smooth_withx)
      lines(q_custom)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-q-fun-2", function() {
      plot(q_smooth_withx, y = NA)
      lines(q_custom, y = NA)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-q-fun-3", function() {
      plot(q_smooth_withx, xlab = "a", ylab = "b", main = "c", type = "p")
      lines(q_custom, lwd = 2)
    }
  )
  vdiffr::expect_doppelganger(
    "plot-lines-q-fun-4", function() {
...
test_that("plot.q_fun and lines.q_fun respect `n_grid` argument", {
  vdiffr::expect_doppelganger(
    "plot-lines-q-fun-n-grid", function() {
...
test_that("plot.r_fun works", {
  vdiffr::expect_doppelganger(
    "plot-r-fun-raw-1", function() {plot(r_raw_withx)}
  )
  vdiffr::expect_doppelganger(
    "plot-r-fun-raw-2", function() {plot(r_raw_withx, y = NA)}
  )
  vdiffr::expect_doppelganger(
    "plot-r-fun-raw-3", function() {
      plot(r_raw_withx, xlab = "a", main = "c")
    }
  )
  vdiffr::expect_doppelganger(
    "plot-r-fun-raw-4", function() {
      plot(r_raw_withx, xlim = c(0, 2), col = "blue", freq = FALSE)
    }
  )

  vdiffr::expect_doppelganger(
    "plot-r-fun-smooth-1", function() {plot(r_smooth_withx)}
  )
  vdiffr::expect_doppelganger(
    "plot-r-fun-smooth-2", function() {plot(r_smooth_withx, y = NA)}
  )
  vdiffr::expect_doppelganger(
    "plot-r-fun-smooth-3",
    function() {plot(r_smooth_withx, xlab = "a", main = "c")}
  )
  vdiffr::expect_doppelganger(
    "plot-r-fun-smooth-4",
    function() {
...
test_that("plot.r_fun respects `n_sample` argument", {
  vdiffr::expect_doppelganger(
    "plot-r-fun-n-sample", function() {plot(r_smooth_withx, n_sample = 10)}
  )
})
