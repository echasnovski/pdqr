...
stat_beta <- list(
  ...
  iqr = diff(qbeta(c(0.25, 0.75), shape1 = 1, shape2 = 3)),
...
stat_beta_inf <- list(
  ...
  iqr = diff(qbeta(c(0.25, 0.75), shape1 = 0.7, shape2 = 0.3)),
...
stat_chisq <- list(
  ...
  var = 4, sd = 2, iqr = diff(qchisq(c(0.25, 0.75), df = 2)),
...
stat_chisq_inf <- list(
  ...
  var = 2, sd = sqrt(2), iqr = diff(qchisq(c(0.25, 0.75), df = 1)),
...
stat_exp <- list(
  ...
  var = 1, sd = 1, iqr = diff(qexp(c(0.25, 0.75))),
...
stat_norm <- list(
  ...
  var = 1, sd = 1, iqr = diff(qnorm(c(0.25, 0.75))),
...
stat_norm_2 <- list(
  ...
  var = 0.01, sd = 0.1, iqr = diff(qnorm(c(0.25, 0.75), mean = 10, sd = 0.1)),
