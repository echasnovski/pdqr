...
- [distr6](https://github.com/alan-turing-institute/distr6): Unified and Object Oriented Probability Distribution Interface for R written in R6.
- [distributions](https://github.com/alexpghayes/distributions): Probability Distributions as S3 Objects (*work in progress*).
...
- [Probability Distributions](https://cran.r-project.org/web/views/Distributions.html) CRAN Task View has more examples of packages intended to work with probability distributions.
