...
# You can plot them directly using base `plot()` and `lines()`
op <- par(mfrow = c(1, 2))
plot(d_mpg_con, main = '"continuous" d-function from sample')
plot(d_mpg_dis, main = '"discrete" d-function from sample', col = "blue")
par(op)
```
...
op <- par(mfrow = c(1, 2))
plot(d_df_con, main = '"continuous" d-function from data frame')
plot(d_df_dis, main = '"discrete" d-function from data frame', col = "blue")
par(op)
```
...
# You can plot them directly using base `plot()` and `lines()`
op <- par(mfrow = c(1, 2))
plot(r_mpg_con, main = '"continuous" r-function from sample')
plot(r_mpg_dis, main = '"discrete" r-function from sample', col = "blue")
par(op)
```
...
op <- par(mfrow = c(1, 2))
plot(r_df_con, main = '"continuous" r-function from data frame')
plot(r_df_dis, main = '"discrete" r-function from data frame', col = "blue")
par(op)
```
